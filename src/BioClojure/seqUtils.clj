...
;;Create a random nucleotide, from a c g t.  Used to generate motifs randomly. 
;;DO NOT Call this method by itself, it will go for infinity. 
(defn rand-aa "Returns a random amino" [] (repeatedly #(get ["A" "Q" "W" "R" "T" "Y" "I" "P" "S" "D" "F" "H" "K" "L" "C" "V" "N" "M"] (rand-int 18))))
...
;;user=> (rand-aa-str 3)                          
(defn rand-aa-str "Returns a random protein" [l] (take l (rand-aa)))
