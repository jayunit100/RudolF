...
;; @Jay -- 'let' is a special form to bind values to lexically-scoped names, not a function
...
(def aaColors 
  ([1 2 3]) ) ;; @Jay -- is this supposed to be a map?  should it be [1 2 3] -- without the parentheses?
